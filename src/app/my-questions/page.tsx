...
export default function MyQuestionsPage() {
  ...
  const paginatedQuestions = filteredQuestions.slice(startIndex, endIndex)
    ...
    // Whether all paginated questions are selected
    const isAllSelected = paginatedQuestions.length > 0 && paginatedQuestions.every(q => q.id && selectedIds.includes(q.id))
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 py-8">
      <div className="max-w-6xl mx-auto px-4 space-y-8">
        ...
        {/* Pagination Controls */}
        {totalPages > 1 && (
          <div className="flex items-center justify-between bg-white/70 backdrop-blur-xl border border-white/20 rounded-2xl shadow-xl p-6">
            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className="px-4 py-2 bg-white border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 flex items-center space-x-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
